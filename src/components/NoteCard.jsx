...
import { setNewOffset, snapToGrid } from "../utils";
...
export const InfoPopup = ({ infoPopup, setInfoPopup }) => {
  ...
  return (
    ...
    >
      ...
      <p>
        <strong>VIN:</strong> {infoPopup.info.VIN}
      </p>
      <p>
        <strong>Motor Type:</strong> {infoPopup.info.motorType}
      </p>
      <p>
        <strong>Mileage:</strong> {infoPopup.info.mileage}
      </p>
      <div>
...
const NoteCard = ({
  ...
  return (
    <div
      ...
      onMouseEnter={() => !infoPopup && setIsHovered(true)}
      onMouseLeave={() => !infoPopup && setIsHovered(false)}
      onMouseDown={() => setInfoPopup(null)}
      onContextMenu={(e) => onNoteRightClick(e, note)}
    >
      <img
        src={infoIcon}
        alt="Info"
      ...
      <textarea
        ...
        defaultValue={body}
      />
      <InfoPopup infoPopup={infoPopup && infoPopup.noteId === note.$id ? infoPopup : null} setInfoPopup={setInfoPopup} />
